...
if __name__ == "__main__":
    ...
    ax.set_xlim([min_val, TIMEOUT_VAL + 10**3])
    ax.set_ylim([min_val, TIMEOUT_VAL + 10**3])
    ax.set_xscale("log")
    ax.set_yscale("log")
    ...
    ax.plot([min_val, TIMEOUT_VAL], [min_val, TIMEOUT_VAL], linestyle="--", color=DIAGONAL_COLOR) # diagonal
    plt.show()
